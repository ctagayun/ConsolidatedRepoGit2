(function() {
    ...
    function BooksController($q, books, dataService, badgeService, $cookies, $cookieStore, $log) {
        ...
        */
        ...
        //retrieves the title of the book from the cookie saved in EditBookController
        vm.favoriteBook = $cookies.favoriteBook;

        //retrieve the last edited book object (note the whole book object not just a string)
        //that we created in EditBookController. "lastEdited" is the key of the object stored in the
        //cookieStore
