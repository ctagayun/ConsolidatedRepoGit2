...
var router_1 = require('@angular/router'); //ActivatedRoute is used to retrieve the parameter from the activated
...
var ProductDetailComponent = (function () {
    ...
    function ProductDetailComponent(_route, //needed to retrieve value of parameters passed to product/id: see ngOnInit()
        _router, //needed by onBack() method
        _productService) {
        this._route = _route;
