...
require('rxjs/add/operator/do'); //for debugging
...
var ProductService = (function () {
    ...
    ProductService.prototype.getProduct = function (id) {
        ...
        return this.http.get(url)
            .map(this.extractData)
            .do(function (data) { return console.log('getProduct: ' + JSON.stringify(data)); }) //the do operator specifies an action to take for each emitted observable.
    ...
    ProductService.prototype.updateProduct = function (product, options) {
        var url = this.baseUrl + "/" + product.id; //concatenate the id of the record to be updated
