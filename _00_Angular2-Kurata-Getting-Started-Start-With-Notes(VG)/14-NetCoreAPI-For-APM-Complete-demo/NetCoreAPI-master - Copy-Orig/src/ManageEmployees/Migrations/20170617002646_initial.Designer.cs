...
namespace ManageEmployees.Migrations
{
    ...
    [Migration("20170617002646_initial")]
            ...
            modelBuilder.Entity("ManageEmployees.Models.Entities.Contract", b =>
                {
                    ...
                    b.Property<DateTime>("EndDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 6, 16, 19, 26, 46, 24, DateTimeKind.Local));
                    ...
                    b.Property<DateTime>("StartDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 6, 16, 19, 26, 46, 23, DateTimeKind.Local));
            ...
            modelBuilder.Entity("ManageEmployees.Models.Entities.Employee", b =>
                {
                    ...
                    b.Property<DateTime>("BirthDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 6, 16, 19, 26, 45, 992, DateTimeKind.Local));
