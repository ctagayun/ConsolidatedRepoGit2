...
var DataService = (function () {
    ...
    DataService.prototype.getOldBookById = function (id) {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_2_rxjs_operators__["a" /* map */])(function (b) { return ({
            bookTitle: b.title,
            year: b.publicationYear
        }); }), 
...
var DashboardComponent = (function () {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        this.dataService.getAllBooks()
            .subscribe(function (data) { return _this.allBooks = data; }, // the first function pass  is the  data from the server as a parameter
        // it will be the array of books and assign
        // it to the "allBooks" property defined above
        function (err) { return console.log(err); }, // the second function returned is any "errors" that occured
        function () { return console.log('All done getting books.'); } // the 3rd function handler pass is the "completion" handler
        );
...
var EditBookComponent = (function () {
    ...
    EditBookComponent.prototype.ngOnInit = function () {
        ...
        this.dataService.getBookById(bookID)
            .subscribe(
        // data (the book from the server) is assigned to selectedBook property.
        function (data) { return _this.selectedBook = data; }, function (err) { return console.log(err); });
