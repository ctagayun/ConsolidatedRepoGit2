    ...
    core_1.NgModule({
        imports: [
            router_1.RouterModule.forRoot([
                ...
                { path: '**', component: page_not_found_component_1.PageNotFoundComponent } //<--- this is from app/module.ts
            ], { enableTracing: true, preloadingStrategy: selective_strategy_service_1.SelectiveStrategy }) // , { enableTracing: true })
        ],
